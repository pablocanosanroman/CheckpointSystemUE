...
ACheckpointSystemUE5Character::ACheckpointSystemUE5Character()
{
...
void ACheckpointSystemUE5Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ACheckpointSystemUE5Character::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Mouse", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &ACheckpointSystemUE5Character::LookUpAtRate);
...
void ACheckpointSystemUE5Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void ACheckpointSystemUE5Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ACheckpointSystemUE5Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ACheckpointSystemUE5Character::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
